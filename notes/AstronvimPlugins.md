...
Here is a link to all of the AstroNvim plugin configuration files.. This is useful to see all the plugins installed by AstroNvim and see their default configuration.
